...
#define GPIO_OUTPUT_NOTIFICATION_LED MICO_GPIO_7 //PB14
#define GPIO_INPUT_BUTTON MICO_GPIO_5     //PB12
#define GPIO_BUTTON_0 MICO_GPIO_4      //PB15
...
void led_button_init(void)
{
	...
	//Button 0 init
	MicoGpioInitialize(GPIO_BUTTON_0, OUTPUT_PUSH_PULL);
	MicoGpioOutputLow(GPIO_BUTTON_0);
